...
*/
TMP117::TMP117 (const uint8_t address, TwoWire *wire)
{
...
/*!
    ...
    @param   _newDataCallback   callback function will be called when new data is available
*/
void TMP117::setCallBack( void (*_newDataCallback)(void) )
{
  newDataCallback = _newDataCallback;
}
...
*/
void TMP117::setAlertCallback (void (*allert_callback)(void), uint8_t pin)
{
  alert_pin = pin;
...
*/
void TMP117::setAlertTemperature (double lowtemp, double hightemp)
{
...
/*!
    ...
    @return   uint16_t  read value of the configuration register          
*/
